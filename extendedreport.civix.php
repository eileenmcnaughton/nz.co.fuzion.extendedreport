...
/**
 * @return CRM_Extendedreport_Upgrader
 */
...
function _extendedreport_civix_civicrm_caseTypes(&$caseTypes) {
  ...
  foreach (_extendedreport_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
...
function _extendedreport_civix_civicrm_angularModules(&$angularModules) {
  ...
  $files = _extendedreport_civix_glob(__DIR__ . '/ang/*.ang.php');
...
function _extendedreport_civix_fixNavigationMenu(&$nodes) {
  ...
  _extendedreport_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _extendedreport_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
  ...
  foreach ($origKeys as $origKey) {
    ...
    if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
      _extendedreport_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
    }
  }
}
